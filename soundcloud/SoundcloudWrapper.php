...
namespace dlds\wrappers\soundcloud;

use components\Services_Soundcloud_Missing_Client_Id_Exception;
use components\Services_Soundcloud_Invalid_Http_Response_Code_Exception;
use components\Services_Soundcloud_Unsupported_Response_Format_Exception;
use components\Services_Soundcloud_Unsupported_Audio_Format_Exception;
use components\Services_Soundcloud_Version;
